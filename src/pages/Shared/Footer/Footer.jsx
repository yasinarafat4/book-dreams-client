  ...
  return (
    <div>
          ...
          <div className="form-control">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="btn bg-[#e84766] hover:bg-[#b000b9] hover:text-white absolute top-0 right-0 rounded-l-none duration-700"
              >
                Subscribe
              </button>
            </div>
      ...
      <footer className="footer px-10 py-4 bg-blue-300 dark:bg-slate-700 text-base-content dark:text-white">
        <div className="flex justify-center items-center  md:items-start md:flex-col grid-flow-col">
          <img className="w-44" src={logo} alt="" />
          <div className="grid grid-flow-col gap-4 md:ml-3">
